...
class ParkmebeliParser(BaseParser):
    def __init__(self):
        self.start_url = "https://parkmebeli.com/"
        self.set_location_script = """
            fetch("https://parkmebeli.com/product/shkaf-shk-2-belyj/", {
                "headers": {
                ...
                "referrer": "https://parkmebeli.com/product/shkaf-shk-2-belyj/",
                "body": "wcpbc-manual-country=KRASNODAR&redirect=1",
                "method": "POST",
                "mode": "cors",
                "credentials": "include"
            });
        ...
        self.skipping_tag_locators = [
            '//p[text()="СТРАНИЦА НЕ НАЙДЕНА"]',
        ]
        self.name_locator = "//h1"
        self.price_locator = '//p[@class="price"]'
        self.min_delay = 2.0
        self.max_delay = 4.0
