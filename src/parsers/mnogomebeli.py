...
from parsers.parsers_config.mnogomebeli import GEO_SETTINGS, SET_LOCATION_JS
...
class MnogomebeliParser(BaseParser):
    def __init__(self, location: str):
        ...
        self.city_locator = '//span[@data-type="city"]'
        self.min_delay = 4.0
        self.max_delay = 7.0
    ...
    def set_location(self):
        ...
        city = GEO_SETTINGS[self.location]["city"]
        region = GEO_SETTINGS[self.location]["region"]
        self.browser.execute_script(SET_LOCATION_JS, city, region)
