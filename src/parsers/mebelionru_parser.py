...
class MebelionParser(BaseParser):
    def __init__(self):
        self.start_url = "https://www.mebelion.ru/"
        self.cookies = [
            {
                "name": "BX_ME_affiliate_name",
        ...
        self.skipping_tag_locators = [
            '//p[@class="top_out_of_stock"]',
        ]
        self.name_locator = '//h1[@class="h1_name"]'
